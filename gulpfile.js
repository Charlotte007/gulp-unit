...
// 调用添加复制功能  -- 可以自定义添加调用
copyCommon('cssframe', 'src/css/*', config.css.dist);
copyCommon('jsPlugin', 'src/plugin/*', config.js.dist);
...
copyCommon('css', 'src/css/*', config.root.dist + "/res/webcss");
// 任务函数
