...
dsy.add("0", ["北京市", "天津市", "上海市", "重庆市", "河北省", "山西省", "内蒙古", "辽宁省", "吉林省", "黑龙江省", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省", "湖南省", "广东省", "广西省", "海南省", "四川省", "贵州省", "云南省", "西藏", "陕西省", "甘肃省", "青海省", "宁夏回族自治区", "新疆", "香港", "澳门", "台湾省"]);
        ...
        Citys: function (opt) {
            ...
            return this.each(function () {
                ...
                for (var i = 0; i < provice.length; i++) {
                    ...
                    var ssss = "";
                    if (typeof (hsh_areaList) != "undefined" && hsh_areaList.length > 0) {
                        if ($.inArray(provice[i], hsh_areaList) == -1) { ssss = "style='display:none;'"; }
                    }
                    $Province.append("<option value='" + provice[i] + "' " + (provice[i] == sheng ? "selected = 'selected'" : "") + " " + ssss + ">" + provice[i] + "</option>");
                }
                ...
                if (shengindex > 0 && dsy.Exists("0_" + (shengindex - 1))) {
                    ...
                    for (var i = 0; i < city11.length; i++) {
                        ...
                        if (typeof (hsh_CityList) != "undefined" && hsh_CityList.length > 0) {
                            if ($.inArray(city11[i], hsh_CityList) == -1) {  continue; }
                        }
                ...
                $Province.change(function () {
                    ...
                    if (ci > 0 && dsy.Exists("0_" + (ci - 1))) {
                        ...
                        for (var i = 0; i < city.length; i++) {
                            if (typeof (hsh_CityList) != "undefined" && hsh_CityList.length > 0) {
                                if ($.inArray(city[i], hsh_CityList) == -1) { continue;}
                            }
